...
echo 'Circle Name,Region Name,Division Name,Office Name,Pincode,OfficeType,Delivery,District,StateName
...
read pin
pin="$pin" bash "../$(dirname "${BASH_SOURCE[0]}")/pincode.sh" 2>&1 < /dev/null
